...
Review the spec with the project-local `spec-self-eval` skill (which
bundles [the checklist](.codex-skills/spec-self-eval/references/REVIEW.md))
before decomposing tasks and again before implementation.
